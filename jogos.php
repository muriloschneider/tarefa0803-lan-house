...
while ($linha = $consulta->fetch(PDO::FETCH_ASSOC)) {
    ...
    <td><a href='marca2.php?acao2=editar&id=<?php echo $linha['id'];?>'><center><img class="icon" src="imagens/editar.jpg" width="25" height="25" alt=""></center></a></td>
    <td><a href="javascript:excluirRegistro('acao2.php?acao2=excluir&id=<?php echo $linha['id'];?>')"><center><img class="icon" src="imagens/excluir.jpg" width="25" height="25" alt=""></center></a></td>
</tr>
